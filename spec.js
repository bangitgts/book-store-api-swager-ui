var spec = {
    ...
    tags: [ // Danh sách các nhóm API: admin, users, images,...
        ...
        },
        {
            ...
            description: "Các API về tài khoản", // Mô tả về nhóm API
        }

    ],
    schemes: ["http"], // Sử dụng scheme gì? HTTP, HTTPS?
    paths: {
        "/product/": { // Đường dẫn. Kết hợp với host và basePath sẽ thành localhost:3000/api/v1/admin/
        ...
        "/account": { // Đường dẫn. Kết hợp với host và basePath sẽ thành localhost:3000/api/v1/admin/
            get: { // Phương thức gửi request: get, post, put, delete
                tags: ["User"],
        ...
        "/account/login": { // Đường dẫn. Kết hợp với host và basePath sẽ thành localhost:3000/api/v1/admin/
        ...
        "/account/register": { // Đường dẫn. Kết hợp với host và basePath sẽ thành localhost:3000/api/v1/admin/
            post: { // Phương thức gửi request: get, post, put, delete
                tags: ["User"],
